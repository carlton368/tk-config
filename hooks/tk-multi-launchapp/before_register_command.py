...
class BeforeRegisterCommand(HookBaseClass):
    ...
    def determine_engine_instance_name(self, software_version, engine_instance_name):
        ...
        if 'WONJIN_BEFORE_REGISTER_COMMAND' in os.environ:
            os.environ['WONJIN_BEFORE_REGISTER_COMMAND'] += os.pathsep + 'WONJIN_BEFORE_REGISTER_COMMAND'
        else:
            os.environ['WONJIN_BEFORE_REGISTER_COMMAND'] = 'WONJIN_BEFORE_REGISTER_COMMAND'
        
        self.parent.log_debug("WONJIN_BEFORE_REGISTER_COMMAND Updated Python paths: %s" % os.environ['WONJIN_BEFORE_REGISTER_COMMAND'])
